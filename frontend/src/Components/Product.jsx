...
const Product = (props) => {
  ...
  const changeColor = () => {
    setTextColor(
      textColor === "text-slate-500" ? "text-red-500" : "text-slate-500"
    );
    props.favClick();
  };
  ...
  return (
    <>
      <div className="cards md:w-[20%] rounded-md shadow-md pb-5 relative">
        <div className="h-4/5">
          ...
          <div>
            <p className="font-poppins text-sm font-semibold pl-2">
              {props.name}
            </p>
